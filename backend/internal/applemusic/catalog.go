...
func (c *CatalogClient) Album(ctx context.Context, storefront, id string) (Collection, error) {
	...
	return Collection{ID: album.ID, Type: TypeAlbum, Name: album.Attributes.Name, Artist: album.Attributes.ArtistName, Tracks: tracks}, nil
}
...
func (c *CatalogClient) Playlist(ctx context.Context, storefront, id string) (Collection, error) {
	...
	return Collection{ID: playlist.ID, Type: TypePlaylist, Name: playlist.Attributes.Name, Artist: firstNonEmpty(playlist.Attributes.CuratorName, playlist.Attributes.ArtistName), Tracks: tracks}, nil
}
...
func (c *CatalogClient) Cover(ctx context.Context, artworkURL, format, size string) ([]byte, error) {
	...
	u := strings.ReplaceAll(artworkURL, "{w}x{h}", size)
...
func mapSong(raw catalogSongData) Song {
	s := Song{
		...
		ContentRating: raw.Attributes.ContentRating, HasLyrics: raw.Attributes.HasTimeSyncedLyrics,
